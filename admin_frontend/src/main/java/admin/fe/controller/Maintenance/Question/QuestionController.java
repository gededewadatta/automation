...
public class QuestionController extends CommonController
		implements PopupCallerDepartmentInterface, PopupCallerDivisionInterface, PopupCallerGradeInterface,
		PopupCallerSubGradeInterface, PopupCallerCompetencyInterface {
	...
	public void onClick$btnCompetencyCode() {
		...
		Component c = Executions.createComponents("layout/Competencies/CompetencyPopUp.zul", self, args);
		try {
