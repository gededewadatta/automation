...
public class ApiClient {
    ...
    public static String pendingQuestion = "http://localhost:7003/automation/api/search/pendingquestion/";
    public static String submitQuestion = "http://localhost:7003/automation/api/insert/history";
    public static String historyAnswer = "http://localhost:7003/automation/api/insert/submitquestion";
    ...
    public ApiResponse<PendingQuestionResponse> login(String email, String password) {

        LoginRequest requestObject = new LoginRequest();
        requestObject.email = email;
        requestObject.password = password;

        return processResponse(pendingQuestion, HttpMethod.POST, requestObject.email, PendingQuestionResponse.class);
    }
